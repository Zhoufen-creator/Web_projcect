        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxPatientsPerWeek = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsReminder24hSent = table.Column<bool>(type: "bit", nullable: false),
                    Reminder24hSentAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsReminder2hSent = table.Column<bool>(type: "bit", nullable: false),
                    Reminder2hSentAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExaminationServices_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExaminationServices_MedicalServices_MedicalServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorAvoid = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AppointmentId = table.Column<int>(type: "int", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    PatientId = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExaminationServices_AppointmentId",
                table: "ExaminationServices",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ExaminationServices_MedicalServiceId",
                table: "ExaminationServices",
